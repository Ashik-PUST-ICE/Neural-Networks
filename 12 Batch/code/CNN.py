...
# Write a MATLAB or Python program to classify face/fruit/bird using Convolution Neural Network (CNN). 

# ###### the data set is  Birds or Fruit Data or  Path to save folder j kono akta used korlei hobe ######
